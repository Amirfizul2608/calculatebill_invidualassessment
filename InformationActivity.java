package com.example.individualassessment;
...
public class InformationActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nameTextView.setText("Name: Muhammad Amir Aiman bin Ruhaifizul");
        groupInfo.setText("Group: NBCS2408A");
        studentNumber.setText("Student Number: 2022807066");
        ...
        profilePicture.setImageResource(R.drawable.amiraiman);

        // Set the clickable link text
        linkText.setText("https://github.com/Amirfizul2608");
        ...
        linkText.setOnClickListener(v -> {
            ...
            Intent browserIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://github.com/Amirfizul2608"));
